...
Stock = [
    ...
    {
        'image':'https://www.geekinsta.com/content/images/2020/04/best-free-image-optimization-and-compression-tools.png',
        'type':'websites',
        ...
        [
            {     
                'id': 0,
                'image':'https://images.squarespace-cdn.com/content/v1/4fcf5c8684aef9ce6e0a44b0/1469558368719-YWREE00FARBIP8WP2J0G/ke17ZwdGBToddI8pDm48kAnM5QPvO4i2ilIV2yihMYVZw-zPPgdn4jUwVcJE1ZvWQUxwkmyExglNqGp0IvTJZUJFbgE-7XRK3dMEBRBhUpzDqJn2RtVoz1jmT9t7QxujMfDPY_FDQUautcbRf0pZH5DY9nn5ZBQswSmufCu5Ea8/B_bKTauUYAAcMyw.png',
                'intro': 'Smart PNG and JPEG compression',
                'type':'website',
                'name': 'TinyPNG',
            ...
            {     
                'id': 0,
                'image':'https://miro.medium.com/max/1960/1*wp-mbM4EUNhroHBUyaFXqg.jpeg',
                'intro': 'Online JPEG and PNG optimizer / compressor with settings and archive download',
                'type':'website',
                'name': 'Optimizilla',
            ...
            {     
                'id': 0,
                'image':'https://www.dev-metal.com/wp-content/uploads/2014/05/compress-png-1280x720.png',
                'intro': 'JPEG, PNG, GIF, SVG Compression',
                'type':'website',
                'name': 'Compressor.io',
            ...
            {     
                'id': 0,
                'image':'https://miro.medium.com/max/1200/1*LUg4ZFqanx4hRkY2Yi8J-Q.jpeg',
                'intro': 'Image compression from Google Chrome Labs',
                'type':'website',
                'name': 'Squoosh.app',
            ...
            {     
                'id': 0,
                'image':'https://bulkresizephotos.com/img/libimgs/bulkresizephotos_ogi.png',
                'intro': 'Bulk image resizing, compression & converting that perform all the tasks within the browser (It works offline)',
                'type':'website',
                'name': 'BulkResizerPhotos',
                'url': 'https://bulkresizephotos.com/en',
            },
            {     
                'id': 0,
                'image':'https://www.iloveimg.com/mediapress/promo3.png',
                'intro': 'The fastest free web app for easy image modification',
                'type':'website',
                'name': 'iLoveIMG',
            ...
            {     
                'id': 0,
                'image':'https://pbs.twimg.com/media/EeQ75tcWoAUIJSZ.png',
                'intro': 'Online SVG optimizer with a lot of settings and possibility to cut and paste svg code directly in it.',
                'type':'website',
                'name': 'SvgOMG',
            ...
            {     
                'id': 0,
                'image':'https://compressjpeg.com/images/compressjpeg/logo.svg',
                'intro': 'Compress JPEG images with size even greater than 5MB',
                'type':'website',
                'name': 'CompressJPEG',
            ...
            {     
                'id': 0,
                'image':'https://cdn.cybrhome.com/media/website/live/screenshot/scr_compressnow.com_c2d9c6.png',
                'intro': 'JPEG, GIF, PNG Compression',
                'type':'website',
                'name': 'CompressNow',
            ...
            {     
                'id': 0,
                'image':'https://ak03-promo-cdn.slidely.com/static/promo-videos/image-resizer/og2.jpg',
                'intro': 'Free Image and Photo Resizer',
                'type':'website',
            ...
            {     
                'id': 0,
                'image':'https://pic.accessify.com/thumbnails/777x423/i/imageoptimizer.net.png',
                'intro': 'Image Optimizer Free With Quality Options',
                'type':'website',
            ...
            {     
                'id': 0,
                'image':'https://res.cloudinary.com/foxscribbler/images/dpr_auto,w_auto,fl_immutable_cache/f_auto,q_auto/w_800,h_496/v1605065255/SVGminify-split-the-code-and-minify/SVGminify-split-the-code-and-minify.jpg',
                'intro': 'This tool removes superfluous information, thereby reducing the size of your SVG files',
                'type':'website',
                'name': 'SVGminify',
            ...
            {     
                'id': 0,
                'image':'https://techviral.net/wp-content/uploads/2019/09/JPEG-Optimizer.jpg',
                'intro': 'Free online tool for resizing and compressing digital photos and images for displaying on the web',
                'type':'website',
                'name': 'JPEG Optimizer',
            ...
            {     
                'id': 0,
                'image':'https://resizing.app/assets/img/facebook.png',
                'intro': 'Resize Your Images Online',
                'type':'website',
                'name': 'Resizing.app',
            ...
            {     
                'id': 0,
                'image':'https://ezgif.com/images/ezgif-maker.png',
                'intro': 'Animated GIF maker and Image editor including Image optimization and supports WebP conversion',
                'type':'website',
                'name': 'EZGif',
                'url': 'https://ezgif.com/',
            },
            {     
                'id': 0,
                'image':'https://onlinepngtools.com/images/preview-image-onlinepngtools.png',
                'intro': 'Resize png for without losing transparent background.',
                'type':'website',
                'name': 'OnlinePngTools',
            ...
            {     
                'id': 0,
                'image':'https://cdn.ilovefreesoftware.com/wp-content/uploads/2016/10/verexif.png',
                'intro': 'Remove meta tags in image in order to reduce image size and increase privacy security',
                'type':'website',
                'name': 'Verexif',
            ...
            {     
                'id': 0,
                'image':'https://vecta.io/nano/images/try-vecta.b3ba8bba77.svg',
                'intro': 'Uses lossless compression to compress inefficient SVG codes by removing unnecessary data. (Free & Paid)',
                'type':'website',
                'name': 'Vecta Nano',
